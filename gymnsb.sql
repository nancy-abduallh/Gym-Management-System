...
ALTER TABLE `health_status`
  ADD FOREIGN KEY (`user_id`) REFERENCES `members` (`user_id`);
  ALTER TABLE `health_status`
...
ALTER TABLE `staffs`
  MODIFY `designation` ENUM('Trainer', 'Manager') NOT NULL;

ALTER TABLE `staffs` 
ADD `amount` int(100) NOT NULL;

ALTER TABLE `staffs` 
ADD   `paid_date` date NOT NULL;
