...
<head>
    ...
    <body style="background:  url(./img/bg-login-page.jpg) no-repeat ; ">
        ...
        <div id="loginbox">            
            ...
            ?>
            <div class="pull-left">
            <a href="customer/index.php"><h6 style="color:black; font-size:larger;">Members Login</h6></a>
            </div>

            <div class="pull-right">
            <a href="staff/index.php"><h6 style="color:black;font-size:larger;">Staff Login</h6></a>
            </div>
                </h>
            <!-- <div class="pull-center" >
            <a href="manager/index.php"><h6 >manager Login</h6></a>
            </div> -->
