...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a><a href="announcement.php">Offer</a> <a href="#" class="current">Manage Offer</a> </div>
    <h1 class="text-center">Manage Offer <i class="fas fa-bullhorn"></i></h1>
  </div>
