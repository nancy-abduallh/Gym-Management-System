...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="staffpayment.php" class="tip-bottom">Payment</a> <a href="#" class="current">Make Payments</a> </div>
  <h1>Payments</h1>
</div>
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            //update query
            $qry = "UPDATE staffs SET amount='$amountpayable', paid_date='$curr_date' WHERE user_id='$id'";
                                    ...
                                    <td class="content-wrap aligncenter print-container">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GMS_<?php echo(rand(100000,10000000));?> <br> 12 Dokki st., <br>Egypt </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>

                                                        <tr>
                                                        <td class="text-center" style="font-size:14px;"><b> <?php echo $fullname; ?></b>  <br>
                                            ...
                                            <tr>
                                                ...
                                                We sincerely appreciate your promptness regarding all your hard work from your side.
                                                </td>
                                            </tr>
                                        </tbody></table>
                                    </td>
           ...
           <?php } else {?>
            ...
            <div class='error_ex'>
            <h1>409</h1>
            <h3>Looks like you've deactivated the staff's account!</h3>
            <p>The selected staff's account will no longer be ACTIVATED until the next payment.</p>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Nancy Abduallh</a> </div>
</div>
