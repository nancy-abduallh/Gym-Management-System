...
<!--sidebar-menu-->
<?php $page='staffpayment'; include 'includes/sidebar.php'?>
<!--sidebar-menu-->

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="staffpayment.php" class="current">Payments</a> </div>
    <h1 class="text-center">Registered Staff's Salary Payment <i class="fas fa-group"></i></h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class='widget-box'>
          <div class='widget-title'> <span class='icon'> <i class='fas fa-th'></i> </span>
            <h5>Staff's Salary Payment table</h5>
          ...
          echo"<table class='table table-bordered data-table table-hover'>
              <thead>
                <tr>
                  <th>#</th>
                  <th>Staff</th>
                  <th>Last Salary Payment Date</th>
                  <th>Designation</th>
                  <th>Amount</th>
                  <th>Action</th>
                </tr>
            ...
            <tbody> 
                ...
                <td><div class='text-center'><?php echo $row['designation']?></div></td>
                <td><div class='text-center'><?php echo '$'.$row['amount']?></div></td>
                <td><div class='text-center'><a href='staff-payment.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='fas fa-dollar-sign'></i> Make Payment</button></a></div></td>
              </tbody>
          <?php $cnt++; }
