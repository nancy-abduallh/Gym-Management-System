            ...
            <div class="row-fluid">
              <div class="span5">
                <table class="">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td >Email: nancy@perfectgym.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="span7">
                <table class="table table-bordered table-invoice">
                  ...
                  <tbody>
				  <form action="staffpay.php" method="POST">
                    <tr>
                    <tr>
                      <td class="width30">Staff's Fullname:</td>
                    ...
                    <tr>
                      ...
                      <td><input id="amount" type="number" name="amount" value='<?php if($row['designation'] == 'Manager') { echo '30000';} elseif ($row['designation'] == 'Trainer') { echo '4000';} else {echo '5000';} ?>' /></td>
                    </tr>

                    <input type="hidden" name="paid_date" value="<?php echo $row['paid_date']; ?>">
					
                  <td class="width30">Duration of employment:</td>
                    <td class="width70">
					<div class="controls">
