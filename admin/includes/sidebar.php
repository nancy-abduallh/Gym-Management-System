<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-users"></i> <span>View Members</span> <span class="label label-important"><?php include 'dashboard-usercount.php';?> </span></a>
      <ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-cogs"></i> <span>Gym Equipment</span> <span class="label label-important"><?php include 'dashboard-equipcount.php';?> </span></a>
    <ul>
    ...
    <li class="<?php if($page=='payment'){ echo 'active'; }?>"><a href="payment.php"><i class="fas fa-hand-holding-usd"></i> <span>Members Payments</span></a></li>
    <li class="<?php if($page=='staffpayment'){ echo 'active'; }?>"><a href="staffpayment.php"><i class="fas fa-hand-holding-usd"></i> <span>Staff Payments</span></a></li>

    <!-- <li class="<?php if($page=='announcement'){ echo 'active'; }?>"><a href="announcement.php"><i class="fas fa-bullhorn"></i> <span>Offers</span></a></li> -->
